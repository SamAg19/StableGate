...
export async function addLiquidity() {
  step(6, 'Adding liquidity to StableGate pool — Unichain Sepolia')
  ...
  await approveToken(CONTRACTS.unichain.usdc,  CONTRACTS.unichain.positionManager, LP_AMOUNT)
  await approveToken(CONTRACTS.unichain.usdt0, CONTRACTS.unichain.positionManager, LP_AMOUNT)
